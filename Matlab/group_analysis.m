...
clear
cd 'C:\Users\Daniel.Feeney\Dropbox (Boa)\SensoriaFolder\ReliabilityTesting'
addpath('C:\Users\Daniel.Feeney\Dropbox (Boa)\SensoriaFolder\SensoriaCode2');
files = dir('*.csv');
longdata(1,1) = struct();
counter = 1;
leftCal = importfile('C:\Users\Daniel.Feeney\Dropbox (Boa)\SensoriaFolder\ReliabilityTesting\Cal.csv');
